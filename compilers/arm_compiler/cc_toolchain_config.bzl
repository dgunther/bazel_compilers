...
def _impl(ctx):
                    ...
                    flag_groups = [
                        flag_group(
                            flags = [
                                ...
                                "-nostdinc",
                                "-isystem",
                                "external/org_linaro_components_toolchain_gcc_armv7/lib/gcc/arm-linux-gnueabihf/5.4.1/include",
                                "-isystem",
                                "external/org_linaro_components_toolchain_gcc_armv7/lib/gcc/arm-linux-gnueabihf/5.4.1/include-fixed",
                                "-isystem",
                                "external/org_linaro_components_toolchain_gcc_armv7/arm-linux-gnueabihf/include/c++/5.4.1",
                                "-isystem",
                ...
                flag_set(
                    ...
                    flag_groups = [
                        flag_group(
                            flags = [
                                "-isystem",
                                "external/org_linaro_components_toolchain_gcc_armv7/arm-linux-gnueabihf/include/c++/5.4.1/arm-linux-gnueabihf",
                                "-isystem",
                                "external/org_linaro_components_toolchain_gcc_armv7/arm-linux-gnueabihf/include/c++/5.4.1",
                                "-isystem",
                                "external/org_linaro_components_toolchain_gcc_armv7/include/c++/5.4.1/arm-linux-gnueabihf",
                                "-isystem",
                                "external/org_linaro_components_toolchain_gcc_armv7/include/c++/5.4.1",
                                "-isystem",
                                "external/org_linaro_components_toolchain_gcc_aarch64/arm-linux-gnueabihf/include/c++/5.4.1",
                            ],
                        ),
                    ],
                ),
    ...
    if (ctx.attr.cpu == "armeabi-v7a"):
        cxx_builtin_include_directories = [
            ...
            "%package(@org_linaro_components_toolchain_gcc_armv7//arm-linux-gnueabihf/libc/lib/gcc/arm-linux-gnueabihf/5.4.1/include-fixed)%",
            "%package(@org_linaro_components_toolchain_gcc_armv7//include)%/c++/5.4.1",
            "%package(@org_linaro_components_toolchain_gcc_armv7//arm-linux-gnueabihf/libc/lib/gcc/arm-linux-gnueabihf/5.4.1/include)%",
            "%package(@org_linaro_components_toolchain_gcc_armv7//lib/gcc/arm-linux-gnueabihf/5.4.1/include)%",
            "%package(@org_linaro_components_toolchain_gcc_armv7//lib/gcc/arm-linux-gnueabihf/5.4.1/include-fixed)%",
            "%package(@org_linaro_components_toolchain_gcc_armv7//arm-linux-gnueabihf/include)%/c++/5.4.1",
        ]
    elif (ctx.attr.cpu == "k8"):
        cxx_builtin_include_directories = [
            "/usr/include/c++/4.8",
